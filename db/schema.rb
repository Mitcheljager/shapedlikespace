...
ActiveRecord::Schema.define(version: 2019_09_24_111556) do
  ...
  create_table "collections", force: :cascade do |t|
    ...
    t.index ["favorites_count"], name: "index_collections_on_favorites_count"
  end
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "favorites_count", default: 0
    t.index ["favorites_count"], name: "index_comments_on_favorites_count"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "simple_mode", default: false
    t.boolean "list_mode", default: false
